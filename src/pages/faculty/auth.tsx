      ...
      if (isLogin) {
        ...
        if (userDoc.exists() && userDoc.data().role === "faculty") {
          toast({
            ...
            description: "Welcome back, Faculty!",
          });
          navigate("/faculty");
        } else {
          await auth.signOut();
          toast({
            variant: "destructive",
            title: "Access Denied",
            description: "You do not have faculty privileges.",
          });
        }
      } else {
        ...
        toast({
          ...
          description: "Your faculty account has been successfully created.",
        });
        navigate("/faculty");
      }
    } catch (error: any) {
        ...
        <div className="text-center">
          <div className="flex justify-center mb-4">
            <div className="w-12 h-12 bg-info rounded-full flex items-center justify-center">
              <User className="w-7 h-7 text-info-foreground" />
            </div>
          </div>
